...
async def read_all_ledgers(user: user_dependency, request: Request, db: Session = Depends(get_db), start_date_filter: Optional[str] = None, end_date_filter: Optional[str] = None):
